...
class ConsultationSummary(BaseModel):
    ...
    severity_assessment: str = Field(description="Clinical assessment of the severity of the patient's condition")
    risk_assessment: str = Field(description="Clinical assessment of the patient's overall risk level")
    red_flag_detection: List[str] = Field(default_factory=list, description="Any immediate red flags or warning signs detected")
    triage_level: UrgencyLevel = Field(description="Final triage urgency assessment")
    differential_diagnoses: List[str] = Field(description="AI-generated differential diagnoses, strictly labeled as possibilities.")
